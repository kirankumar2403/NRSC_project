...
# Metadata (same as in run_detection.py)
metadata = {
...
print("="*60)
print("CLOUD AND SHADOW DETECTION - TRAINING AND PROCESSING")
print("="*60)
...
print("- evaluation_metrics.csv: Training and evaluation metrics")
